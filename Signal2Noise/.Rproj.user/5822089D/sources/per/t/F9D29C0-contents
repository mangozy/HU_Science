...
hilln1_macro_value = round(trial2$Hills_N1,4)
hilln2_macro_value = round(trial2$Hills_N2,4)
margalef_macro_value = round(trial2$margalef,4)

hilln1_fish_value = round(gam_dat2$Hills_N1,4)
hilln2_fish_value = round(gam_dat2$Hills_N2,4)
margalef_fish_value = round(gam_dat2$margalef,4)
